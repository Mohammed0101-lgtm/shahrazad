...
int Position::numberOf(pieceType piece, int color) const {
    ...
    switch (piece) {
        ...
        case QUEEN  : 
            return color == WHITE ? 
                        white_queens.count() : black_queens.count();
        
        case ROOK   : 
            return color == WHITE ? 
                        white_rooks.count() : black_rooks.count();
        
        case BISHOP : 
            return color == WHITE ? 
                        white_bishops.count() : black_bishops.count();
        
        case KNIGHT : 
            return color == WHITE ? 
                        white_knights.count() : white_knights.count();
        
        case PAWN   : 
            return color == WHITE ? 
                        white_pawns.count() : white_pawns.count();
...
int Position::isPinned(const int sq) const {
    ...
    Bitboard opponent_occupancy = current_side == WHITE ?
                                        _black_occupancy() : _white_occupancy();
